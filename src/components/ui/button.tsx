...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-brand text-bg-base shadow-xs hover:bg-brand-hover",
        destructive:
          "bg-red-500 text-white shadow-xs hover:bg-red-600 focus-visible:ring-red-500/20",
        outline:
          "border border-border-medium bg-transparent shadow-xs hover:bg-bg-card-hover hover:text-text-primary",
        secondary: "bg-bg-card text-text-primary shadow-xs hover:bg-bg-card-hover",
        ghost: "hover:bg-bg-card-hover hover:text-text-primary",
